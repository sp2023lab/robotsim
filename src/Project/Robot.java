...
public class Robot {
	...
	public void tryToMove(RobotArena arena) {
		...
		**/
		...
		if (arena.canMoveHere(newX, newY)) { //Checks if the robot can move to the new position (newX and newY)
			updatePos(newX, newY); //Calls the function which updates the position for the x and y coordinate of the robot
		}
	...
	public void updatePos(int x, int y) {
		xPos = x; //x position is updated
		yPos = y; //y position is updated
	}
	...
	public String toString() {
		return "Robot ID: " +ID()+",\nthe coordinates for this robot are: ("+xPos()+","+yPos()+"),\nand the direction is: "+direction()+".\n"; 
